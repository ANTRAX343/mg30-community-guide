...
![Effect Type](https://img.shields.io/badge/Type-Noise%20Gate-red.svg)
...
- 📱 **Recording** - Clean up tracks without affecting tone

Perfect for any setup where noise control is crucial without sacrificing musical expression.

## Parameters

| Parameter | Range | Default | Description |
|-----------|-------|---------|-------------|
| **SENS** | 0–100 | 50 | Sensitivity threshold - determines at what level the gate opens |
| **DECAY** | 0–100 | 50 | Release time - how quickly the gate closes when signal drops |

---

**Next**: [EFX Effects](../efx/README.md) | **Previous**: [CMP Effects](../cmp/README.md) | **Up**: [Effects Overview](../README.md)
